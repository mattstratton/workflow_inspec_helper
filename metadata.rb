...
issues_url 'https://github.com/mattstratton/workflow_inspec_helper/issues' if respond_to?(:issues_url)

# If you upload to Supermarket you should set this so your cookbook
# gets a `View Source` link
source_url 'https://github.com/mattstratton/workflow_inspec_helper' if respond_to?(:source_url)
